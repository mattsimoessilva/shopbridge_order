...
VALID_ORDER_ID = str(str4())
VALID_CUSTOMER_ID = str(str4())
VALID_PRODUCT_ID = str(str4())


def full_order_dict(order_id=None, customer_id=None, status="PENDING"):
    return {
        "id": str(order_id) if order_id else str4(),
        "created_at": datetime.now(timezone.utc),
        "updated_at": None,
        "customer_id": str(customer_id) if customer_id else str4(),
